...
c = "https://www.amazon.com/best-sellers-books-Amazon/zgbs/books/ref=zg_bs_pg_"
loop_link = "_encoding=UTF8&pg="

for i in range(1, 6):
    url = c + str(i) + loop_link + str(i)
    ...
    for i in main:
        ...
        if par:
            ...
            URLs.append("https://www.amazon.com" + sublink)
        else:
